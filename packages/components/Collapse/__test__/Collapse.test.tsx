...
import transitionEvents from "../src/transitionEvents";
...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".lotus-collapse-item__header");
    contents = wrapper.findAll(".lotus-collapse-item__wrapper");
...
describe("Collapse/transitionEvents.ts", () => {
  ...
  test("enter", () => {
    ...
    expect(el.style.height).toBe(`${el.scrollHeight}px`);
  });
  test("afterEnter", () => {
